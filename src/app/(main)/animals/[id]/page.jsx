...
const AnimalsDetailsPage = async ({params}) => {
  ...
  <div className="card-body items-center text-center">
    ...
    <div className="flex gap-3 justify-evenly items-start"><span>Breed:{singleAnimal.breed} ||</span> <span>Price:{singleAnimal.weight} ||</span> <span>Age:{singleAnimal.age}</span></div>
